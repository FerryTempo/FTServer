...
```txt
https://www.ferrytempo.com/schemas/FerryTempo.schema.json#/$defs/ferryTempoRouteData/properties/boatData/patternProperties/^boat[1-9][0-9]*$
```
