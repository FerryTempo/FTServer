...
* [Untitled array in Ferry Tempo Data](./ferrytempo-defs-ferry-tempo-single-port-data-properties-portschedulelist.md "List of scheduled departures for the sailing day") – `https://www.ferrytempo.com/schemas/FerryTempo.schema.json#/$defs/singlePortData/properties/PortScheduleList`
